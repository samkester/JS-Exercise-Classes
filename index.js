...
class Car {
  ...
  drive(distance){
    let report = `Drove ${distance} miles.`;
    if(distance > this.tank * this.milesPerGallon)
    {
      distance = this.tank * this.milesPerGallon;
      report = `Ran out of fuel after ${distance} miles.`;
    }
...
*/
class Lambdasian { // I think "Lambdian" rolls off the tongue better myself, but there's no accounting for taste
  constructor(args){
    this.name = args.name;
    this.age = args.age;
...
class Instructor extends Lambdasian{
  constructor(args){
    ...
    this.catchPhrase = args.catchPhrase; // one day I yearn to have a tryPhrase and maybe a finallyPhrase
  }
  demo(subject){
